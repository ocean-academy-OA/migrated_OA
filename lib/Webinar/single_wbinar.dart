                  ...
                  if (!snapshot.hasData) {
                    ...
                    for (var a in getFreeWebinar.docs) {
                      ...
                      sDate = DateTime(
                          ...
                          .inSeconds;
                      final topicSubtitle = a['topic subtitle'];
                      final topicTitle = a['topic title'];
                      ...
                      final webinarVideo = a['webinar video'];
                      final dBcourse = a['course'];
                      final dBsuperTitle = a['super title'];
                      final dBmainSubtitle = a['main subtitle'];
                      final dBmainTitle = a['main title'];
                      final dBtrainerImage = a['trainer image'];
                      final dBtrainerName = a['trainer name'];
                      final dBpayment = a['payment'];
                      String dBstudentEnrolled = a['student enrolled'];
                      final dBwebinarDuration = a['webinar duration'];
                      final dBmentorImage = a['mentor image'];
                      final dBaboutMentor = a['about mentor'];
