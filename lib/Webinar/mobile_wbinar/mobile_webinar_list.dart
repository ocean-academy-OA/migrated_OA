          ...
          builder: (context, snapshot) {
            if (!snapshot.hasData) {
              ...
              for (var message in messages) {
                ...
                final trainerName = message['trainer name'];
                final payment = message['payment'];
                final designation = message['designation'];
                final trainerImage = message['trainer image'];
                final mainTitle = message['main subtitle'];
